...
const
   SCRIPT_CLEAR_DATA =
    'select * from DELETETENANT (2);' + sLineBreak +
    '\' + sLineBreak +
    'select * from DELETETENANT (3);' + sLineBreak +
    '\' + sLineBreak +
...
const
  ...
  _SCRIPT_INSERT_TENANTS =
    'INSERT INTO TENANTS VALUES (2, ''%s'', 1, ''Downtown Toy Store'', ''6f548ce232672b19919083472870c7e5'', ''ujvHhO'', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, '''');' +  sLineBreak +{  Password: "1" }
    '\' + sLineBreak +
    'INSERT INTO TENANTS VALUES (3, ''%s'', 1, ''Midtown Toy Store'', ''4b5db52b1a8ae8b62aed06de31203f57'', ''ULJvCp'', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, '''');';{ Password: "2" }
